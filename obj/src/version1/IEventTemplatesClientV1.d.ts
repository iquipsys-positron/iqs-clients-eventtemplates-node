...
export interface IEventTemplatesClientV1 {
    ...
    getTemplateById(correlationId: string, template_id: string, callback: (err: any, template: EventTemplateV1) => void): void;
    ...
    deleteTemplateById(correlationId: string, template_id: string, callback: (err: any, template: EventTemplateV1) => void): void;
}
